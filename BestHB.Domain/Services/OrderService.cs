...
namespace BestHB.Domain.Services
{
    public class OrderService : IOrderService
    {
        ...
        public int Create(CreateOrderCommand createOrderCommand)
        {
            ...
            if (createOrderCommand.UserId <= 0) //TODO: separar os ifs em outro metodo para validacao da order
        ...
        public Task<DeleteOrderStatus> Delete(DeleteOrderCommand deleteOrderCommand) //TODO: remover delete e update pois nao tem implementacao
        {
